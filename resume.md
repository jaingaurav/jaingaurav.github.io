...
- Optimized the gVisor runtime — cut virtual-memory bookkeeping (VMA entries) by 182x on memory-heavy workloads, and improved ARM compatibility for ML libraries with better CPU virtualization.
